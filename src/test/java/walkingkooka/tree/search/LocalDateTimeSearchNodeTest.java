...
public final class LocalDateTimeSearchNodeTest extends SearchNodeLeafTestCase<LocalDateTimeSearchNode, LocalDateTime> {
    ...
    public void testAccept() {
        ...
        final LocalDateTimeSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected void visit(final LocalDateTimeSearchNode n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    public void testToString() {
        this.toStringAndCheck(this.createSearchNode(), DATETIMESTRING);
    }

    @Test
    public void testToString2() {
        this.toStringAndCheck(this.createSearchNode(DIFFERENT_DATETIME_STRING),
                DIFFERENT_DATETIME_STRING);
    }
    ...
    private LocalDateTimeSearchNode createSearchNode(final String value) {
        return this.createSearchNode(LocalDateTime.parse(value));
    }

    @Override
    LocalDateTimeSearchNode createSearchNode(final String text, final LocalDateTime value) {
    ...
    @Override
    Class<LocalDateTimeSearchNode> searchNodeType() {
        return LocalDateTimeSearchNode.class;
    }
}
