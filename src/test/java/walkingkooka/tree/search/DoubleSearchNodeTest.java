...
public final class DoubleSearchNodeTest extends SearchNodeLeafTestCase<DoubleSearchNode, Double> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final DoubleSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected void visit(final DoubleSearchNode n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    private DoubleSearchNode createSearchNode(final double value) {
        return this.createSearchNode(Double.valueOf(value));
    }

    @Override
    DoubleSearchNode createSearchNode(final String text, final Double value) {
    ...
    @Override
    Class<DoubleSearchNode> searchNodeType() {
        return DoubleSearchNode.class;
    }
}
