...
public final class SearchQueryLeafValueLessThanEqualsTest extends SearchQueryLeafValueTestCase<SearchQueryLeafValueLessThanEquals> {
    ...
    public void testBigDecimalLess() {
        ...
        final SearchQuery query = this.bigDecimalQueryValue(VALUE).lessThanEquals();
    ...
    public void testBigDecimalReplaceSelection() {
        ...
        this.querySelectAndCheck(query,
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after),
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after));
    }
    ...
    @Test
    public void testBigDecimalIgnoresOtherTypes() {
        final SearchNode before = this.before();
        final SearchNode after = this.after();
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigIntegerNode, doubleNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testBigDecimalLessNot() {
        final BigDecimalSearchNode node = this.bigDecimalNode(VALUE_LT);
        final SearchQuery query = this.bigDecimalQueryValue(VALUE).lessThanEquals().not();
    ...
    public void testBigIntegerLess() {
        ...
        final SearchQuery query = this.bigIntegerQueryValue(VALUE).lessThanEquals();
    ...
    @Test
    public void testBigIntegerIgnoresOtherTypes() {
        final SearchNode before = this.before();
        final SearchNode after = this.after();
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigDecimalNode, doubleNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testBigIntegerLessNot() {
        final BigIntegerSearchNode node = this.bigIntegerNode(VALUE_LT);
        final SearchQuery query = this.bigIntegerQueryValue(VALUE).lessThanEquals().not();
    ...
    public void testDoubleLess() {
        ...
        final SearchQuery query = this.doubleQueryValue(VALUE).lessThanEquals();
    ...
    @Test
    public void testDoubleIgnoresOtherTypes() {
        final SearchNode before = this.before();
        final SearchNode after = this.after();
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testDoubleLessNot() {
        final DoubleSearchNode node = this.doubleNode(VALUE_LT);
        final SearchQuery query = this.doubleQueryValue(VALUE).lessThanEquals().not();
    ...
    public void testLocalDateLess() {
        ...
        final SearchQuery query = this.localDateQueryValue(DATE).lessThanEquals();
    ...
    @Test
    public void testLocalDateIgnoresOtherTypes() {
        final SearchNode before = this.before();
        final SearchNode after = this.after();
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testLocalDateLessNot() {
        final LocalDateSearchNode node = this.localDateNode(DATE_LT);
        final SearchQuery query = this.localDateQueryValue(DATE).lessThanEquals().not();
    ...
    public void testLocalDateTimeLess() {
        ...
        final SearchQuery query = this.localDateTimeQueryValue(DATETIME).lessThanEquals();
    ...
    public void testLocalDateTimeIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, timeNode, longNode, textNode));
    }

    @Test
    public void testLocalDateTimeLessNot() {
        final LocalDateTimeSearchNode node = this.localDateTimeNode(DATETIME_LT);
        final SearchQuery query = this.localDateTimeQueryValue(DATETIME).lessThanEquals().not();
    ...
    public void testLocalTimeLess() {
        ...
        final SearchQuery query = this.localTimeQueryValue(TIME).lessThanEquals();
    ...
    @Test
    public void testLocalTimeIgnoresOtherTypes() {
        final SearchNode before = this.before();
        final SearchNode after = this.after();
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, dateTimeNode, longNode, textNode));
    }

    @Test
    public void testLocalTimeLessNot() {
        final LocalTimeSearchNode node = this.localTimeNode(TIME_LT);
        final SearchQuery query = this.localTimeQueryValue(TIME).lessThanEquals().not();
    ...
    public void testLongLess() {
        ...
        final SearchQuery query = this.longQueryValue(VALUE).lessThanEquals();
    ...
    @Test
    public void testLongIgnoresOtherTypes() {
        final SearchNode before = this.before();
        final SearchNode after = this.after();
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt.selected(), eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, dateTimeNode, timeNode, textNode));
    }

    @Test
    public void testLongLessNot() {
        final LongSearchNode node = this.longNode(VALUE_LT);
        final SearchQuery query = this.longQueryValue(VALUE).lessThanEquals().not();
    ...
    public void testTextLess() {
        ...
        final SearchQuery query = this.textQueryValue(TEXT).lessThanEquals(CaseSensitivity.SENSITIVE);
    ...
    public void testTextReplaceSelection() {
        ...
        final SearchQuery query = this.textQueryValue(TEXT).lessThanEquals(CaseSensitivity.SENSITIVE);
        this.querySelectAndCheck(query,
                this.sequenceNode(before.selected(), lt.selected(), eq.selected(), gt, after),
                this.sequenceNode(before.selected(), lt.selected(), eq.selected(), gt, after));
    }
    ...
    public void testTextLessNot() {
        final TextSearchNode node = this.textNode(TEXT_LT);
        final SearchQuery query = this.textQueryValue(TEXT).lessThanEquals(CaseSensitivity.SENSITIVE).not();
    ...
    public void testTextLessInsensitive() {
        final TextSearchNode node = this.textNode(TEXT_LT);
        final SearchQuery query = this.textQueryValue(TEXT2).lessThanEquals(CaseSensitivity.INSENSITIVE);
    ...
    @Override
    SearchQueryLeafValueLessThanEquals createSearchQuery(final TextSearchQueryValue value, final SearchQueryTester tester) {
    ...
    @Override
    public Class<SearchQueryLeafValueLessThanEquals> type() {
        return SearchQueryLeafValueLessThanEquals.class;
    }
}
