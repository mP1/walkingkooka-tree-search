...
public final class SequenceSearchNodeTest extends SearchNodeParentTestCase<SequenceSearchNode> {

    @Test
    public void testWithNullFails() {
        assertThrows(NullPointerException.class, () -> SequenceSearchNode.with(null));
    }

    @Test
    public void testWithEmptyFails() {
        assertThrows(IllegalArgumentException.class, () -> SequenceSearchNode.with(Lists.empty()));
    }
    ...
    public void testAccept() {
        ...
        final SequenceSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SequenceSearchNode n) {
                assertSame(node, n);
                b.append("3");
                return Visiting.CONTINUE;
            }
            ...
            @Override
            protected void endVisit(final SequenceSearchNode n) {
                assertSame(node, n);
                b.append("4");
            }
    ...
    public void testExtractFirstChild() {
        final SequenceSearchNode all = this.sequence(this.child1(), this.child2(), this.child3());
    ...
    private void extractAndCheck2(final SequenceSearchNode sequence, final int beginOffset, final int endOffset, final SearchNode... expected) {
        Assertions.assertEquals(this.sequence(expected),
                sequence.extract(beginOffset, endOffset),
                "sequence " + sequence + " begin: " + beginOffset + " end: " + endOffset);
    }
    ...
    @Override
    SequenceSearchNode createSearchNode() {
        return SequenceSearchNode.with(this.children());
    }
    ...
    @Override
    Class<SequenceSearchNode> searchNodeType() {
        return SequenceSearchNode.class;
    }
}
