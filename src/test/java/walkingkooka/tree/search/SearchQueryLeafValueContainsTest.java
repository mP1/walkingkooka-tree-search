...
public final class SearchQueryLeafValueContainsTest extends SearchQueryLeafTestCase<SearchQueryLeafValueContains> {
    ...
    public void testEqualsDifferentText() {
        this.checkNotEquals(SearchQueryLeafValueContains.with(this.textQueryValue("different"), this.caseSensitivity()));
    }

    @Test
    public void testEqualsDifferentCaseSensitivity() {
        this.checkNotEquals(SearchQueryLeafValueContains.with(this.queryTextValue(), SENSITIVITY.invert()));
    }

    @Override
    SearchQueryLeafValueContains createSearchQuery() {
    ...
    @Override
    public Class<SearchQueryLeafValueContains> type() {
        return SearchQueryLeafValueContains.class;
    }
}
