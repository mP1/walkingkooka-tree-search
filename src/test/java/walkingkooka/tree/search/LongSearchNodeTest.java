...
public final class LongSearchNodeTest extends SearchNodeLeafTestCase<LongSearchNode, Long> {
    ...
    public void testAccept() {
        ...
        final LongSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected void visit(final LongSearchNode n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    private LongSearchNode createSearchNode(final long value) {
        return this.createSearchNode(Long.valueOf(value));
    }

    @Override
    LongSearchNode createSearchNode(final String text, final Long value) {
    ...
    @Override
    Class<LongSearchNode> searchNodeType() {
        return LongSearchNode.class;
    }
}
