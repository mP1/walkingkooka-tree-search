...
public final class LocalTimeSearchNodeTest extends SearchNodeLeafTestCase<LocalTimeSearchNode, LocalTime> {
    ...
    public void testAccept() {
        ...
        final LocalTimeSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected void visit(final LocalTimeSearchNode n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    @Override
    LocalTimeSearchNode createSearchNode(final String text, final LocalTime value) {
    ...
    @Override
    Class<LocalTimeSearchNode> searchNodeType() {
        return LocalTimeSearchNode.class;
    }
}
