...
public final class SearchQueryLeafAttributeValueDoesntContainsTest extends SearchQueryLeafAttributeTestCase<SearchQueryLeafAttributeValueDoesntContains> {
    ...
    @Override
    public Class<SearchQueryLeafAttributeValueDoesntContains> type() {
        return SearchQueryLeafAttributeValueDoesntContains.class;
    }
}
