...
public final class SearchQueryParentBinaryOrTest extends SearchQueryParentBinaryTestCase<SearchQueryParentBinaryOr> {
    ...
    @Override
    SearchQueryParentBinaryOr createSearchQuery(final SearchQuery left, final SearchQuery right) {
        return SearchQueryParentBinaryOr.with(left, right);
    }

    @Override
    public Class<SearchQueryParentBinaryOr> type() {
        return SearchQueryParentBinaryOr.class;
    }
}
