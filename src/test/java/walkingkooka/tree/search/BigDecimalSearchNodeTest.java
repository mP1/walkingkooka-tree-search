...
public final class BigDecimalSearchNodeTest extends SearchNodeLeafTestCase<BigDecimalSearchNode, BigDecimal> {
    ...
    public void testAccept() {
        ...
        final BigDecimalSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected void visit(final BigDecimalSearchNode n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    @Override
    BigDecimalSearchNode createSearchNode(final String text, final BigDecimal value) {
    ...
    @Override
    Class<BigDecimalSearchNode> searchNodeType() {
        return BigDecimalSearchNode.class;
    }
}
