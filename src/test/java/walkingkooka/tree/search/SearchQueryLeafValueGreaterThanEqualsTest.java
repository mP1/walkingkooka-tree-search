...
public final class SearchQueryLeafValueGreaterThanEqualsTest extends SearchQueryLeafValueTestCase<SearchQueryLeafValueGreaterThanEquals> {
    ...
    @Override
    SearchQueryLeafValueGreaterThanEquals createSearchQuery(final TextSearchQueryValue value, final SearchQueryTester tester) {
    ...
    @Override
    public Class<SearchQueryLeafValueGreaterThanEquals> type() {
        return SearchQueryLeafValueGreaterThanEquals.class;
    }
}
