...
public final class BigIntegerSearchNodeTest extends SearchNodeLeafTestCase<BigIntegerSearchNode, BigInteger> {
    ...
    public void testAccept() {
        ...
        final BigIntegerSearchNode node = this.createSearchNode();
        ...
        new FakeSearchNodeVisitor() {
            ...
            @Override
            protected void visit(final BigIntegerSearchNode n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    @Override
    BigIntegerSearchNode createSearchNode(final String text, final BigInteger value) {
    ...
    @Override
    Class<BigIntegerSearchNode> searchNodeType() {
        return BigIntegerSearchNode.class;
    }
}
