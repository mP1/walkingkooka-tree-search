...
public final class SearchQueryLeafValueEqualsTest extends SearchQueryLeafValueTestCase<SearchQueryLeafValueEquals> {
    ...
    public final void testBigDecimalReplaceSelection() {
        ...
        this.querySelectAndCheck(query,
                this.sequenceNode(before, lt, eq.selected(), gt, after),
                this.sequenceNode(before, lt, eq.selected(), gt, after));
    }
    ...
    public final void testBigDecimalIgnoreOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq.selected(), gt, after, bigIntegerNode, doubleNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }
    ...
    public final void testBigIntegerIgnoreOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq.selected(), gt, after, bigDecimalNode, doubleNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }
    ...
    public final void testDoubleIgnoreOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }
    ...
    public final void testLocalDateIgnoreOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateTimeNode, timeNode, longNode, textNode));
    }
    ...
    public final void testLocalDateTimeIgnoreOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, timeNode, longNode, textNode));
    }
    ...
    public final void testLongIgnoreOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq.selected(), gt, after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, dateTimeNode, timeNode, textNode));
    }
    ...
    @Override
    SearchQueryLeafValueEquals createSearchQuery(final TextSearchQueryValue value, final SearchQueryTester tester) {
    ...
    @Override
    public Class<SearchQueryLeafValueEquals> type() {
        return SearchQueryLeafValueEquals.class;
    }
}
