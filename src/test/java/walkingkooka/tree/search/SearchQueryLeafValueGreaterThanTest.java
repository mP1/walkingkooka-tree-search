...
public final class SearchQueryLeafValueGreaterThanTest extends SearchQueryLeafValueTestCase<SearchQueryLeafValueGreaterThan> {
    ...
    public void testBigDecimalLess() {
        ...
        final SearchQuery query = this.bigDecimalQueryValue(VALUE).greaterThan();
    ...
    public void testBigDecimalReplaceSelection() {
        ...
        this.querySelectAndCheck(query,
                this.sequenceNode(before, lt, eq, gt.selected(), after),
                this.sequenceNode(before, lt, eq, gt.selected(), after));
    }
    ...
    public void testBigDecimalIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigIntegerNode, doubleNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testBigDecimalLessNot() {
        final BigDecimalSearchNode node = this.bigDecimalNode(VALUE_LT);
        final SearchQuery query = this.bigDecimalQueryValue(VALUE).greaterThan().not();
    ...
    public void testBigIntegerLess() {
        ...
        final SearchQuery query = this.bigIntegerQueryValue(VALUE).greaterThan();
    ...
    public void testBigIntegerIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigDecimalNode, doubleNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testBigIntegerLessNot() {
        final BigIntegerSearchNode node = this.bigIntegerNode(VALUE_LT);
        final SearchQuery query = this.bigIntegerQueryValue(VALUE).greaterThan().not();
    ...
    public void testDoubleLess() {
        ...
        final SearchQuery query = this.doubleQueryValue(VALUE).greaterThan();
    ...
    public void testDoubleIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigDecimalNode, bigIntegerNode, dateNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testDoubleLessNot() {
        final DoubleSearchNode node = this.doubleNode(VALUE_LT);
        final SearchQuery query = this.doubleQueryValue(VALUE).greaterThan().not();
    ...
    public void testLocalDateLess() {
        ...
        final SearchQuery query = this.localDateQueryValue(DATE).greaterThan();
    ...
    public void testLocalDateIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigDecimalNode, bigIntegerNode, doubleNode, dateTimeNode, timeNode, longNode, textNode));
    }

    @Test
    public void testLocalDateLessNot() {
        final LocalDateSearchNode node = this.localDateNode(DATE_LT);
        final SearchQuery query = this.localDateQueryValue(DATE).greaterThan().not();
    ...
    public void testLocalDateTimeLess() {
        ...
        final SearchQuery query = this.localDateTimeQueryValue(DATETIME).greaterThan();
    ...
    public void testLocalDateTimeIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, timeNode, longNode, textNode));
    }

    @Test
    public void testLocalDateTimeLessNot() {
        final LocalDateTimeSearchNode node = this.localDateTimeNode(DATETIME_LT);
        final SearchQuery query = this.localDateTimeQueryValue(DATETIME).greaterThan().not();
    ...
    public void testLocalTimeLess() {
        ...
        final SearchQuery query = this.localTimeQueryValue(TIME).greaterThan();
    ...
    public void testLocalTimeIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, dateTimeNode, longNode, textNode));
    }

    @Test
    public void testLocalTimeLessNot() {
        final LocalTimeSearchNode node = this.localTimeNode(TIME_LT);
        final SearchQuery query = this.localTimeQueryValue(TIME).greaterThan().not();
    ...
    public void testLongLess() {
        ...
        final SearchQuery query = this.longQueryValue(VALUE).greaterThan();
    ...
    public void testLongIgnoresOtherTypes() {
        ...
        this.querySelectAndCheck(query,
                ...
                this.sequenceNode(before, lt, eq, gt.selected(), after, bigDecimalNode, bigIntegerNode, doubleNode, dateNode, dateTimeNode, timeNode, textNode));
    }

    @Test
    public void testLongLessNot() {
        final LongSearchNode node = this.longNode(VALUE_LT);
        final SearchQuery query = this.longQueryValue(VALUE).greaterThan().not();
    ...
    public void testTextLess() {
        ...
        final SearchQuery query = this.textQueryValue(TEXT).greaterThan(CaseSensitivity.SENSITIVE);
    ...
    public void testTextReplaceSelection() {
        ...
        final SearchQuery query = this.textQueryValue(TEXT).greaterThan(CaseSensitivity.SENSITIVE);
        this.querySelectAndCheck(query,
                this.sequenceNode(before, lt, eq, gt.selected(), after.selected()),
                this.sequenceNode(before, lt, eq, gt.selected(), after.selected()));
    }
    ...
    public void testTextLessNot() {
        final TextSearchNode node = this.textNode(TEXT_LT);
        final SearchQuery query = this.textQueryValue(TEXT).greaterThan(CaseSensitivity.SENSITIVE).not();
    ...
    public void testTextLessInsensitive() {
        final TextSearchNode node = this.textNode(TEXT_LT);
        final SearchQuery query = this.textQueryValue(TEXT2).greaterThan(CaseSensitivity.INSENSITIVE);
    ...
    @Override
    SearchQueryLeafValueGreaterThan createSearchQuery(final TextSearchQueryValue value, final SearchQueryTester tester) {
    ...
    @Override
    public Class<SearchQueryLeafValueGreaterThan> type() {
        return SearchQueryLeafValueGreaterThan.class;
    }
}
