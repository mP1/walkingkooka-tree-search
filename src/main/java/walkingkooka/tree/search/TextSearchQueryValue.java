 ...
 */
public final class TextSearchQueryValue extends SearchQueryValue {

    static TextSearchQueryValue with(final String value) {
        check(value);
        return new TextSearchQueryValue(value);
    }

    private TextSearchQueryValue(final String value) {
        super();
        this.value = value;
    }
    ...
    private TextSearchQueryValueSearchQueryTester tester(final CaseSensitivity caseSensitivity, final SearchQueryValueSearchQueryTesterComparisonPredicate resultPredicate) {
        Objects.requireNonNull(caseSensitivity, "caseSensitivity");
        return TextSearchQueryValueSearchQueryTester.with(this.value, caseSensitivity, resultPredicate);
    }
    ...
    boolean canBeEqual(final Object other) {
        return other instanceof TextSearchQueryValue;
    }
