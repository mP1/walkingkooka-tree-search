...
final class SearchQueryLeafAttributeValueEquals extends SearchQueryLeafAttribute {
    ...
    public SearchQuery not() {
        return SearchQuery.attributeValueNotEquals(this.value, this.attributeName, this.caseSensitivity);
    }

    @Override
    boolean test(final String text, final String attributeValue) {
        return this.caseSensitivity.equals(text, attributeValue);
    }

    @Override
    boolean canBeEqual(final Object other) {
        return other instanceof SearchQueryLeafAttributeValueEquals;
    }
