...
abstract class SearchNodeParent extends SearchNode {
     ...
     */
    SearchNodeParent(final int index, final SearchNodeName name, final List<SearchNode> children) {
        super(index, name);
    ...
    @Override
    final SearchNodeParent removeParent1() {
     ...
     * eg {@link SelectSearchNode} also unwraps already selected children.
     */
    ...
    final SearchNodeParent replaceChildren(final List<SearchNode> children) {
    ...
    abstract SearchNodeParent replace0(final int index, final SearchNodeName name, final List<SearchNode> children);
