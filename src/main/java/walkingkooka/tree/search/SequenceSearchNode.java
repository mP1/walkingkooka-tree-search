 ...
 */
public final class SequenceSearchNode extends SearchNodeParent2 {

    public final static SearchNodeName NAME = SearchNodeName.fromClass(SequenceSearchNode.class);

    static SequenceSearchNode with(final List<SearchNode> children) {
        Objects.requireNonNull(children, "children");

        return new SequenceSearchNode(NO_INDEX, NAME, children);
    }

    private SequenceSearchNode(final int index, final SearchNodeName name, final List<SearchNode> children) {
    ...
    @Override
    public SequenceSearchNode setName(final SearchNodeName name) {
        return super.setName0(name).cast();
    }

    @Override
    public SequenceSearchNode removeParent() {
    ...
    @Override
    public SequenceSearchNode setChildren(final List<SearchNode> children) {
    ...
    SearchNodeParent replace0(final int index, final SearchNodeName name, final List<SearchNode> children) {
        return new SequenceSearchNode(index, name, children);
    }
    ...
    final SearchNode extract0(final int extractBeginOffset, final int extractEndOffset, final String ignoredText) {
        ...
        // only wrap multiple extracted nodes in a SequenceSearchNode.
        return extracted.size() == 1 ?
                extracted.get(0) :
                new SequenceSearchNode(NO_INDEX, this.name, extracted);
    }
    ...
    boolean canBeEqual(final Object other) {
        return other instanceof SequenceSearchNode;
    }
