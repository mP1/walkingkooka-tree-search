...
abstract class SearchQueryParentBinary extends SearchQueryParent {
    ...
    SearchQueryParentBinary(final SearchQuery left, final SearchQuery right) {
        this.left = left;
        this.right = right;
    }
     ...
     */
    abstract SearchQueryParentBinarySearchQueryContext context(final SearchQueryContext context);
    ...
    private boolean equals1(final SearchQueryParentBinary other) {
