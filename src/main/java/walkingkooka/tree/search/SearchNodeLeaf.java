...
abstract class SearchNodeLeaf<V> extends SearchNode implements Value<V> {
    ...
    SearchNodeLeaf(final int index, final SearchNodeName name, final String text, final V value) {
        super(index, name);
        this.text = text;
        this.value = value;
    }
     ...
     */
    abstract public SearchNodeLeaf<V> setValue(final V value);

    final SearchNodeLeaf<V> setValue0(final V value) {
        checkValue(value);
    ...
    final SearchNodeLeaf<V> replaceValue(final V value) {
    ...
    /**
     * Sub classes of {@link SearchNodeLeaf} should call this and cast.
     */
    final SearchNodeLeaf removeParent1() {
        return this.replace0(NO_INDEX, this.defaultName(), this.text, this.value);
    }

    abstract SearchNodeLeaf replace0(final int index, final SearchNodeName name, final String text, final V value);
    ...
    final MetaSearchNode setAttributes0(final Map<SearchNodeAttributeName, String> attributes) {
        return MetaSearchNode.with0(this, attributes);
    }

    // Select...........................................................................................

    @Override
    public final IgnoredSearchNode ignored() {
        return SearchNode.ignored(this);
    }

    @Override
    public final SelectSearchNode selected() {
        return SearchNode.select(this);
    }

    /**
     * By definition {@link SearchNodeLeaf} never have a child so theres nothing to replace.
     */
    @Override
    final SearchNode replaceSelected0(final Function<SelectSearchNode, SearchNode> replacer) {
        return this;
    }
    ...
    final boolean equalsIgnoringParentAndChildren0(final SearchNode other) {
        return other instanceof SearchNodeLeaf && this.equalsIgnoringParentAndChildren1(Cast.to(other));
    }

    private boolean equalsIgnoringParentAndChildren1(final SearchNodeLeaf<?> other) {
